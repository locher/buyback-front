 ...
 * 
 * @export
 * @interface UserSessionSsoOutputJsonldUserPlebicomSessionDocumentation
 */
export interface UserSessionSsoOutputJsonldUserPlebicomSessionDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserSessionSsoOutputJsonldUserPlebicomSessionDocumentation
     */
