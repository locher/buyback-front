 ...
 * 
 * @export
 * @interface UserTokenJsonldUserUpdateEmailUserChangePasswordDocumentation
 */
export interface UserTokenJsonldUserUpdateEmailUserChangePasswordDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserTokenJsonldUserUpdateEmailUserChangePasswordDocumentation
     */
