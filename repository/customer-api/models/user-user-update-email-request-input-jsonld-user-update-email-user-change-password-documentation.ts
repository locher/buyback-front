 ...
 * 
 * @export
 * @interface UserUserUpdateEmailRequestInputJsonldUserUpdateEmailUserChangePasswordDocumentation
 */
export interface UserUserUpdateEmailRequestInputJsonldUserUpdateEmailUserChangePasswordDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserUserUpdateEmailRequestInputJsonldUserUpdateEmailUserChangePasswordDocumentation
     */
