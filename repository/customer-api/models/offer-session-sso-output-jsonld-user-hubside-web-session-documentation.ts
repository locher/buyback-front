 ...
 * 
 * @export
 * @interface OfferSessionSsoOutputJsonldUserHubsideWebSessionDocumentation
 */
export interface OfferSessionSsoOutputJsonldUserHubsideWebSessionDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof OfferSessionSsoOutputJsonldUserHubsideWebSessionDocumentation
     */
