 ...
 * 
 * @export
 * @interface OfferInfoClickAndGiftPartnerOutputJsonldAccountClickAndGiftInfosDocumentation
 */
export interface OfferInfoClickAndGiftPartnerOutputJsonldAccountClickAndGiftInfosDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof OfferInfoClickAndGiftPartnerOutputJsonldAccountClickAndGiftInfosDocumentation
     */
