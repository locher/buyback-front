 ...
 * 
 * @export
 * @interface UserUserActivateAccountRequestInputJsonldUserActivateAccountDocumentation
 */
export interface UserUserActivateAccountRequestInputJsonldUserActivateAccountDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserUserActivateAccountRequestInputJsonldUserActivateAccountDocumentation
     */
