 ...
 * 
 * @export
 * @interface OfferJsonldAccountAdvantageDocumentation
 */
export interface OfferJsonldAccountAdvantageDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof OfferJsonldAccountAdvantageDocumentation
     */
