 ...
 * 
 * @export
 * @interface UserUserSendSmsRequestInputJsonldUserSendSmsAccountDocumentation
 */
export interface UserUserSendSmsRequestInputJsonldUserSendSmsAccountDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserUserSendSmsRequestInputJsonldUserSendSmsAccountDocumentation
     */
