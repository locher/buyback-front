 ...
 * 
 * @export
 * @interface CustomerFormResponseOutputJsonldUserCustomerFormSendMessageDocumentation
 */
export interface CustomerFormResponseOutputJsonldUserCustomerFormSendMessageDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof CustomerFormResponseOutputJsonldUserCustomerFormSendMessageDocumentation
     */
