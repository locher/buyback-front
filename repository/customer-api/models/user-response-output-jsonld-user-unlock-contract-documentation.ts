 ...
 * 
 * @export
 * @interface UserResponseOutputJsonldUserUnlockContractDocumentation
 */
export interface UserResponseOutputJsonldUserUnlockContractDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserResponseOutputJsonldUserUnlockContractDocumentation
     */
