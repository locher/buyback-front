 ...
 * 
 * @export
 * @interface ProductDeclarationProductDeclarationInputJsonldProductDeclarationWriteDocumentation
 */
export interface ProductDeclarationProductDeclarationInputJsonldProductDeclarationWriteDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof ProductDeclarationProductDeclarationInputJsonldProductDeclarationWriteDocumentation
     */
