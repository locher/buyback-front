 ...
 * 
 * @export
 * @interface UserUserContactSendMessageRequestInputJsonldUserSendMessageDocumentation
 */
export interface UserUserContactSendMessageRequestInputJsonldUserSendMessageDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserUserContactSendMessageRequestInputJsonldUserSendMessageDocumentation
     */
