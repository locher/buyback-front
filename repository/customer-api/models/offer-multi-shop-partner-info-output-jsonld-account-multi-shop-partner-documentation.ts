 ...
 * 
 * @export
 * @interface OfferMultiShopPartnerInfoOutputJsonldAccountMultiShopPartnerDocumentation
 */
export interface OfferMultiShopPartnerInfoOutputJsonldAccountMultiShopPartnerDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof OfferMultiShopPartnerInfoOutputJsonldAccountMultiShopPartnerDocumentation
     */
