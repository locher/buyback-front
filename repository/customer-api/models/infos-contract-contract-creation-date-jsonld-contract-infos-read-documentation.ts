 ...
 * 
 * @export
 * @interface InfosContractContractCreationDateJsonldContractInfosReadDocumentation
 */
export interface InfosContractContractCreationDateJsonldContractInfosReadDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof InfosContractContractCreationDateJsonldContractInfosReadDocumentation
     */
