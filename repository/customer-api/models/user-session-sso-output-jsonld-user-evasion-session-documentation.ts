 ...
 * 
 * @export
 * @interface UserSessionSsoOutputJsonldUserEvasionSessionDocumentation
 */
export interface UserSessionSsoOutputJsonldUserEvasionSessionDocumentation {
    /**
     * 
     * @type {AddressJsonldContractInfosReadDocumentationContext}
     * @memberof UserSessionSsoOutputJsonldUserEvasionSessionDocumentation
     */
